...
<div class="page-content container note-has-grid">
    <ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
        ...
        <li class="nav-item ml-auto" onclick="addNewAlbum();">
            ...
            <div class="modal-content border-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="image-wrapper" style="display: none;">
                        <img id="modal-image" src="" style="width: 200px; height: 200px;"  alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
                    </div>                 
                </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //     console.log("??",album.asset_id);

        // if(album.asset_id != 0 && album.asset_id != null)
        // {   
        //     var img_tag = '<img id="modal-image" src="/assets/img/album/'+ album.asset_file_name +'.'+ album.asset_file_extension +'"style="width: 200px; height: 200px"  alt="" class="img-fluid rounded shadow-sm mx-auto d-block">';

        //     $(".image-wrapper").html(img_tag);
        // }
        // else
        // {
        //     $(".image-wrapper").html("");
    ...
    function editPhoto(album){
        ...
        if(album.asset_id != 0 && album.asset_id != null)
        {   
            var src_text = '/assets/img/album/'+ album.asset_file_name +'.'+ album.asset_file_extension;

            console.log("src_text",src_text);

            $("#modal-image").attr('src',src_text);
            $(".image-wrapper").show();

            // <img id="modal-image" src="/assets/img/album/'+ album.asset_file_name +'.'+ album.asset_file_extension +'"style="width: 200px; height: 200px"  alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
        ...
        {
            console.log("!23123123",$("#modal-image").attr('src'));
        }
    }
    ...
    * ========================================== */
    ...
    function clickhide(elem){
        ...
        blog_ajax("put","/blog/clickhide",ajax_data,function(resp){
                alert("나만보기로 게시물이 변경되었습니다.");
                $('.lock-off-'+photo_id).hide();
                $('.lock-on-'+photo_id).show();
    ...
    //언더바 : view, 변수 이름
    //Camel방식 : view파일 제외 파일 이름들(php),function이름
    //대쉬 : url, class, id
    function clickopen(elem){
        ...
        blog_ajax("put","/blog/clickopen",ajax_data,function(resp){
            alert("전체보기로 게시물이 변경되었습니다.");
            $('.lock-on-'+photo_id).hide();
            $('.lock-off-'+photo_id).show();
        });
    ...
    function updatePhoto(elem){
        ...
        var asset_id =uploadPhoto('#upload','/upload/upload-photo','album');
        ...
        blog_ajax("put","/blog/update-photo",ajax_data,function(resp){
            ...
            $.each($(".single-note-item"), function(idx, note){
                if($(note).attr("data-id") == photo_id)
                {
                    ...
                    //$(note).find("#img-fluid").text(resp.content);
                }
            });
    ...
    function addPhoto(){
        ...
        var asset_id = uploadPhoto('#upload','/upload/upload-photo','album');
        console.log("add photo asset_id",asset_id);
