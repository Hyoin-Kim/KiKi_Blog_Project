...
<script type="text/javascript">
    ...
    function viewPhotoType(type){
        var current_friend_id = {{ $current_friend_id }};
        blog_ajax("get",'/blog/get-friend-album-list',{'view_type' : type, 'current_friend_id' : current_friend_id},function(resp){
    ...
    * ========================================== */
    ...
    function clickopen(elem){
        var photo_id = $(elem).parents(".single-note-item").attr('data_id');
