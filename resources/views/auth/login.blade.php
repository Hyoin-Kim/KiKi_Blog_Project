...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header btn btn-warning">{{ __('로그인') }}</div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{ url("/assets/howl005.jpg") }}" class="d-block w-100" alt="first" style="width: 580px;height: 350px">
    </div>
    <div class="carousel-item">
      <img src="{{ url("/assets/howl017.jpg") }}" class="d-block w-100" alt="second" style="width: 580px;height: 350px">
    </div>
    <div class="carousel-item">
       <img src="{{ url("/assets/howl033.jpg") }}" class="d-block w-100" alt="third" style="width: 580px;height: 350px">
    </div>
  </div>
